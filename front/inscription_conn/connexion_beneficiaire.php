...
<div class="container">
    ...
    <div class="right-side">
        <form class="login-form">
            ...
            <button id="validationButton" type="submit" class="login-button" ><?php echo htmlspecialchars($data["LOGIN_BUTTON"]); ?></button>
            <a href="#" class="forgot-password"><?php echo htmlspecialchars($data["FORGOT_PASSWORD"]); ?></a>
        </form>
    </div>
</div>

<script src="../scripts/api_integration/login_beneficiaries.js"></script>
</body>
</html>
