...
INSERT INTO Utilisateurs (
  Nom, Prenom, Email, Mot_de_passe, Adresse, Telephone, Date_de_naissance, Langues, Nationalite, 
  Date_d_inscription, Statut, Situation, Emploi, Societe, Est_Verifie, Code_Verification, Type_Permis,
  Date_Derniere_Connexion, Statut_Connexion, Statut_Benevole
) VALUES (
  'Dupont', 'Jean', 'jean.dupont@email.com', 'password123', '123 Rue de Paris', '0123456789', '1980-01-01', 
  'Français', 'Française', CURDATE(), TRUE, 'Célibataire', 'Ingénieur', 'ABC Inc.', TRUE, 'XYZ123', 'B',
  NULL, NULL, 'En attente de validation'
), (
  'Martin', 'Alice', 'alice.martin@email.com', 'password123', '124 Rue de Paris', '0123456790', '1990-02-02',
  'Français, Anglais', 'Française', CURDATE(), TRUE, 'Mariée', 'Médecin', 'Santé+', TRUE, 'XYZ456', 'B',
  NULL, NULL, 'En attente de validation'
);
