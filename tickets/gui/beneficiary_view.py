# gui/beneficiary_view.py
import tkinter as tk
from tkinter import ttk, messagebox, simpledialog
from gui.chat_view import ChatView

class BeneficiaryView:
    def __init__(self, master, user_id, ticket_system, chat_manager):
        self.master = master
        ...
        self.master.title("Espace Bénéficiaire")
        ...
        self.header_label = tk.Label(self.header_frame, text="Beneficiary Dashboard", font=("Arial", 18), fg="white", bg="#4CAF50")
    ...
    def open_chat_with_admin(self, ticket_id, admin_id):
        try:
            ...
            chat_view = ChatView(chat_window, self.user_id, admin_id, self.chat_manager, self.ticket_id)
        except ValueError:
